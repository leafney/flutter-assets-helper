...
type Message struct {
	...
	Type        int64  `protobuf:"varint,1,opt,name=type,proto3" json:"type,omitempty"`               // 消息类型：1.心跳消息 2.普通消息
	Content     string `protobuf:"bytes,2,opt,name=content,proto3" json:"content,omitempty"`          // 文本消息内容
	ContentType int64  `protobuf:"varint,3,opt,name=contentType,proto3" json:"contentType,omitempty"` // 消息内容类型 1.文字 2.色值 3.图片 4.压缩文件
	File        []byte `protobuf:"bytes,4,opt,name=file,proto3" json:"file,omitempty"`                // 图片、文件等二进制
	FileSuffix  string `protobuf:"bytes,5,opt,name=fileSuffix,proto3" json:"fileSuffix,omitempty"`    // 文件后缀
}
...
var file_protocol_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x22, 0x8d, 0x01, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x12,
	...
	0x03, 0x52, 0x0b, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x12,
	0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x66, 0x69,
	0x6c, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x66, 0x69, 0x6c, 0x65, 0x53, 0x75, 0x66, 0x66, 0x69, 0x78,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x66, 0x69, 0x6c, 0x65, 0x53, 0x75, 0x66, 0x66,
	0x69, 0x78, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
